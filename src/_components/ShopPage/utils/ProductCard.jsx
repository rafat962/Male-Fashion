...
const ProductCard = ({ product }) => {
    ...
    return (
        <div className="group relative bg-white border border-border transition-all duration-300 flex flex-col h-full">
            {/* ── Badge ─────────────────────────────────────── */}
            ...
            <div className="relative overflow-hidden aspect-square bg-bg-light p-2 sm:p-4 shrink-0">
                ...
                <button
                    ...
                    className="absolute top-2 right-2 w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center
                               bg-white border border-border md:opacity-0 md:group-hover:opacity-100
            ...
            <div className="p-3 sm:p-4 flex flex-col flex-1">
                <p className="text-[10px] sm:text-[0.65rem] font-bold uppercase tracking-widest text-sub mb-1">
                    {product.category}
                </p>
                ...
                <div className="flex flex-col xl:flex-row items-stretch gap-2 mt-auto">
                    ...
                    <div className="flex items-center border border-border h-8">
                        <button
                            ...
                            className="flex-1 sm:w-8 flex items-center justify-center text-dark
                        ...
                        <input
                            ...
                            className="w-8 sm:w-10 text-center text-xs sm:text-sm font-bold text-dark
                                       border-x border-border outline-none bg-transparent"
                        />
                        <button
                            onClick={() => handleQty(qty + 1)}
                            className="flex-1 sm:w-8 flex items-center justify-center text-dark
                    ...
                    <button
                        ...
                        className="flex-[2] h-8 bg-dark text-white text-[10px] sm:text-[0.65rem] font-bold
